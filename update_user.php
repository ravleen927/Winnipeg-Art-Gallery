            ...
            <div class="col-md-6">
                ...
                <h2 class="mb-4 text-center">Update Account</h2>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="username" placeholder="Enter username" value="<?= $fetch_profile["name"]; ?>">
                        <input type="hidden" name="prev_pass" value="<?= $fetch_profile["password"]; ?>">
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" class="form-control" name="email" id="email" placeholder="Enter email" value="<?= $fetch_profile["email"]; ?>">
                    </div><br>
                    <div class="form-group">
